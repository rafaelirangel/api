...
/** 
 * @api {GET} /trails/:cityName Get hiking trails by the name of the city.
...
/** 
 * @api {GET} /trails/:cityName/:name Get a hiking trail by its Name
...
/** 
 * @api {PUT} /trails Update num_reviews of all hiking trails
